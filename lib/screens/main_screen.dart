...
*/
  ...
  _MainScreenState(
      this.token, this.service, this._selectedIndex, this._initialOrderTab);
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((message) {
      if (message.notification != null) {
        ...
        AudioPlayer().play(AssetSource('simple_notification.mp3'));
        AudioPlayer().play(AssetSource('audio/simple_notification.mp3'));
        AudioPlayer().play(AssetSource('assets/audio/simple_notification.mp3'));
    ...
    mainService = service;
    api.userLang(
        trrrr.LocalizationService.getCurrentLangInt(), userData!.content!.id);
  }
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _widgetOptions = <Widget>[
      ...
      Container(
        child: !worker
            ? UserOrder(initialOrderTab: _initialOrderTab)
            ...
            children: [
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                ...
                                image: userInfo == null ||
                                        userInfo.isEmpty ||
                                        userInfo['ImagePath'] ==
                                            '$apiDomain/ProfilesFiles/${userInfo["Id"]} '
                          ...
                          Column(
                            ...
                            children: [
                              MyWidget(context).textTitle15(
                                  '${userInfo == null || userInfo.isEmpty ? "" : userInfo["Name"]}'),
                              MyWidget(context).textTap25(
                                  '${userInfo == null || userInfo.isEmpty ? "" : userInfo["Email"]}'),
                              worker && !isBoss
                                  ? Switch(
                                      value: userInfo['OnlineStatus'] != null &&
              ...
              Expanded(
                ...
                child: GestureDetector(
                  ...
                  child: MyWidget(context).rowIconProfile(Icons.person_outlined,
              ...
              Expanded(
                ...
                child: GestureDetector(
                  ...
                  child: MyWidget(context).rowIconProfile(
              ...
              Expanded(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    var _selectedCountry = country.indexWhere(
                            (element) => element['Name'] == myCountry) ??
                        0;
                    await APIService.getCityData(
                        country[_selectedCountry]['Id']);
                    var _selectedCity = city.indexWhere(
                            (element) => element['Name'] == myCity) ??
                        0;
              ...
              Expanded(
                ...
                child: GestureDetector(
                  child: MyWidget(context)
                      .rowIconProfile(Icons.more_horiz, "FAQs".tr),
                  // onTap: ()=> showRewardAdd(),
                ),
              ),
              SizedBox(
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            ...
                            size: min(MediaQuery.of(context).size.width / 12,
    ...
    return Scaffold(
      ...
      appBar: MyWidget.appBar(
          title: AppLocalizations.of(context)!.translate('Our Services'),
          isMain: true,
          key: _key),
      drawer: MyWidget(context).drawer(barHight,
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(
            icon:
                !worker ? Icon(Icons.shopping_cart_outlined) : Icon(Icons.work),
            // ignore: deprecated_member_use
            label: !worker
                ? AppLocalizations.of(context)!.translate('My Order')
                : isBoss
                    ? AppLocalizations.of(context)!.translate('My Order')
                    : AppLocalizations.of(context)!.translate('MY TASK'),
          ),
          BottomNavigationBarItem(
  ...
  Future getMyOrders(
    ...
    if (NewOrdersSupervisor.length > 0) {
      ...
      if (superNewOrderData.length > 0) finishedOrderData.clear();
  ...
  Future updateUserInfo(var id) async {
    try {
      print("flag1");
      var url =
          Uri.parse("$apiDomain/Main/Users/SignUp_Read?filter=Id~eq~'$id'");
      http.Response response = await http.get(
        url,
        headers: {
          "Authorization": token,
      ...
      if (response.statusCode == 200) {
        ...
        if (userInfo['GroupUsers'].length > 0)
          _checkWorkerType(
              userInfo['Type'], userInfo['GroupUsers'][0]['isBoss']);
        else {
