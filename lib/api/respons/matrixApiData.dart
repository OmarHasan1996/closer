...
//
//     final matrixApi = matrixApiFromJson(jsonString);

import 'dart:convert';

MatrixApi matrixApiFromJson(String str) => MatrixApi.fromJson(json.decode(str));

String matrixApiToJson(MatrixApi data) => json.encode(data.toJson());
...
class MatrixApi {
  ...
  factory MatrixApi.fromJson(Map<String, dynamic> json) => MatrixApi(
